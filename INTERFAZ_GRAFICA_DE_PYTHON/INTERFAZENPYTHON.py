...
class App:
    ...
    def create_perfil_section(self):
        ...
        tk.Label(frame, text="Aquí se muestra toda la información del estudiante.", font=("Arial", 12), bg="white").pack()
        return frame
    ...
    def create_tareas_section(self):
        ...
        columns = ("Proyecto", "Fecha Límite", "Estado")
        tree = ttk.Treeview(frame, columns=columns, show="headings", height=10)
        tree.heading("Proyecto", text="NOMBRE DEL PROYECTO")
        tree.heading("Fecha Límite", text="FECHA LIMITE")
